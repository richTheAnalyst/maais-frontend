...
export function RevisionsFeed() {
  ...
  if (selectedRev) {
    return (
      <div className="flex-1 itms-center justify-centre">
        Loading...
              ...
              >
                ...
                >
                  ...
                  <span className="text-[10px] font-black uppercase tracking-[0.2em]">
                    {isHOD ? "Back to Audit Feed" : "Back to Revision Feed"}
                  </span>
                </button>
                  ...
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="bg-gray-50/30 border-b border-gray-100 text-[10px] font-black text-gray-400 uppercase tracking-widest">
                        <th className="px-6 py-4 border-r border-gray-50">
                          Index
                        </th>
                        <th className="px-6 py-4 border-r border-gray-50">
                          Student Name
                        ...
                        {isExamExpanded ? (
                          <>
                            <th className="px-4 py-4 border-r border-gray-50 text-center bg-emerald-50/20 text-emerald-800">
                              Sec A
                            </th>
                            <th className="px-4 py-4 border-r border-gray-50 text-center bg-rose-50/30 text-rose-800">
                              Sec B (Target)
                            </th>
                            <th className="px-4 py-4 border-r border-gray-50 text-center bg-emerald-50/20 text-emerald-800">
                              Sec C
                    ...
                    <tbody className="divide-y divide-gray-50">
                      {students.map((student) => {
                        ...
                        return (
                          ...
                          >
                            <td className="px-6 py-4 text-sm font-bold text-gray-400 border-r border-gray-50">
                              {student.index}
                            </td>
                            <td className="px-6 py-4 text-sm font-black text-gray-900 border-r border-gray-50">
                              {student.name}
                            </td>
                            {isExamExpanded ? (
                              <>
                                <td className="px-4 py-4 text-sm font-bold text-center border-r border-gray-50 text-emerald-700">
                                  {student.secA}
                                </td>
                                <td
                                  className={cn(
                                    ...
                                    isTarget
                                      ? "ring-2 ring-inset ring-rose-500 bg-white"
                                      : "text-gray-900",
                                  )}
                                >
                                  {isTarget && !isHOD ? (
                              ...
                              <td className="px-4 py-4 text-sm font-bold text-center border-r border-gray-50">
                                {student.exam}
                              </td>
                            )}
            ...
            >
                    ...
                    <p className="text-[13px] text-gray-700 italic leading-relaxed font-medium">
                      {isHOD ? (
                        ...
                        <span className="group-hover:text-red-900 transition-colors">
                          <span className="font-black text-red-800 not-italic uppercase text-[10px]">
                            HOD:{" "}
                          </span>
              ...
              <div className="space-y-4 flex-1">
                ...
                <textarea
                  ...
                  placeholder={
                    isHOD
                      ? "Flag this entry for teacher revision..."
                      : "Briefly state reason for change..."
                  }
              ...
              <button
                ...
                className={cn(
                  ...
                  isHOD
                    ? "bg-rose-600 text-white hover:bg-black shadow-rose-600/10"
                    : "bg-emerald-900 text-white hover:bg-black shadow-emerald-900/10",
                )}
              >
          ...
          <div className="flex items-center gap-4 mb-3">
            ...
            <div>
              ...
              <p className="text-[10px] font-black text-emerald-800 uppercase tracking-widest mt-1">
                {isHOD
                  ? "Departmental oversight of assessment integrity"
                  : "Surgical focus on departmental corrections requested by the HOD"}
              </p>
            </div>
          </div>
        </header>
        ...
        {revisions.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-500 font-medium">
              No pending revisions from the HOD.
            </p>
          </div>
        )}
      </motion.div>
