        ...
        <main className="flex-1 flex overflow-hidden relative">
            <Routes>
              ...
              <Route path="/timetable" element={
                ...
                (user?.role === 'SUPER_ADMIN' || user?.role === 'HEADMASTER') ? <SchedulingView /> : <Timetable />
              } />
              <Route path="/archive" element={<ArchiveView />} />
              <Route path="/grading" element={(user?.role === 'SUPER_ADMIN' || user?.role === 'HEADMASTER') ? <GradingRulesView /> : <GradingSheet />} />
              ...
              <Route path="/settings" element={
                ...
                (user?.role === 'SUPER_ADMIN' || user?.role === 'HEADMASTER') ? <AdminSettings /> :
                <SettingsView />
              } />
              <Route path="/support" element={
                user?.role === 'STUDENT' ? <StudentSupport /> : 
                user?.role === 'HOD' ? <HODSupport /> : 
                (user?.role === 'SUPER_ADMIN' || user?.role === 'HEADMASTER') ? <AdminSupport /> :
                <SupportView />
              } />
            </Routes>
